...
TARGET_KERNEL_SOURCE := kernel/lge/lito
TARGET_KERNEL_CLANG_COMPILE := true
TARGET_KERNEL_CONFIG := vendor/caymanlm-perf_defconfig
...
BOARD_PRODUCTIMAGE_PARTITION_RESERVED_SIZE := 3640655872
BOARD_SYSTEMIMAGE_EXTFS_INODE_COUNT := -1
BOARD_SYSTEMIMAGE_PARTITION_RESERVED_SIZE := 3640655872
endif
BOARD_PRODUCTIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_SYSTEMIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_LGE_DYNAMIC_PARTITIONS_PARTITION_LIST := product system
BOARD_LGE_DYNAMIC_PARTITIONS_SIZE := 7511998464
...
-include vendor/lge/g900em/BoardConfigVendor.mk
